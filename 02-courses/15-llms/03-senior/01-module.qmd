...
Conceptos básicos de Módulo 1 — Senior.

### Código Ejecutable

```{python}
# Ejemplo básico del módulo 1
print("Hola desde LLMs & Generative AI — Módulo 1")
```
...
Conceptos intermedios de Módulo 1 — Senior.
