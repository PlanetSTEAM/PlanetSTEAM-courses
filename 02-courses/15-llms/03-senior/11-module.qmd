...
Conceptos básicos de Módulo 11 — Senior.

### Código Ejecutable

```{python}
# Ejemplo básico del módulo 11
print("Hola desde LLMs & Generative AI — Módulo 11")
```
...
Conceptos intermedios de Módulo 11 — Senior.
