...
Conceptos básicos de Módulo 2 — Senior.

### Código Ejecutable

```{python}
# Ejemplo básico del módulo 2
print("Hola desde LLMs & Generative AI — Módulo 2")
```
...
Conceptos intermedios de Módulo 2 — Senior.
