...
Conceptos básicos de Módulo 8 — Senior.

### Código Ejecutable

```{python}
# Ejemplo básico del módulo 8
print("Hola desde LLMs & Generative AI — Módulo 8")
```
...
Conceptos intermedios de Módulo 8 — Senior.
