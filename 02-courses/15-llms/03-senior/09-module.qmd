...
Conceptos básicos de Módulo 9 — Senior.

### Código Ejecutable

```{python}
# Ejemplo básico del módulo 9
print("Hola desde LLMs & Generative AI — Módulo 9")
```
...
Conceptos intermedios de Módulo 9 — Senior.
