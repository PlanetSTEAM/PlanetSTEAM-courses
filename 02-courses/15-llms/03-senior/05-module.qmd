...
Conceptos básicos de Módulo 5 — Senior.

### Código Ejecutable

```{python}
# Ejemplo básico del módulo 5
print("Hola desde LLMs & Generative AI — Módulo 5")
```
...
Conceptos intermedios de Módulo 5 — Senior.
