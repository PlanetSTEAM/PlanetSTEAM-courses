...
Conceptos básicos de Módulo 4 — Senior.

### Código Ejecutable

```{python}
# Ejemplo básico del módulo 4
print("Hola desde LLMs & Generative AI — Módulo 4")
```
...
Conceptos intermedios de Módulo 4 — Senior.
