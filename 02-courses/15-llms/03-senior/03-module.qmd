...
Conceptos básicos de Módulo 3 — Senior.

### Código Ejecutable

```{python}
# Ejemplo básico del módulo 3
print("Hola desde LLMs & Generative AI — Módulo 3")
```
...
Conceptos intermedios de Módulo 3 — Senior.
